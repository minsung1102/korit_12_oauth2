    ...
    <Container maxWidth='sm'>
      <Box sx={{mt: 8}}>
        <Paper elevation={3} sx={{p: 4, textAlign: 'center'}}>
          ...
          {/* user?.name : user가 UserInfo 자료형을 따르는 객체거나 null이라는 뜻인데, null이면 name이 없습니다. 그때 오류 발생 안하고 undefined를 리턴해주게됩니다. */}
          <Typography variant="h5" fontWeight='bold' gutterBottom>
            환영합니다, {user?.name}님!
          </Typography>

          <Box sx={{textAlign: 'left', bgcolor: 'grey.50', borderRadius:1, mb: 3}}>
