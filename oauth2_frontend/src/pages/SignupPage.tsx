...
import { Container, Box, TextField, Typography, Alert, Divider, CircularProgress, Paper, Button } from "@mui/material";
        ...
        <Paper elevation={3} sx={{ p: 4, width: '100%' }}>
          ...
          {signupMutation.isError && (
            <Alert severity="error" sx={{ mb: 2}}>
              {/*error 자체는 unknown 타입으로 명확하게 Error 인스턴스라고 볼 수 없기 때문에 삼항연ㅅㅇ자를 통해 메시지를 별개로 출력 */}
          ...
          <Box component='form' onSubmit={handleSubmit}>
            ...
            />
            <TextField 
              fullWidth label='이메일' name='email' value={form.email} onChange={handleChange} error={!!errors.email} helperText={errors.email} margin='normal' type='email'
            />
            <TextField 
          ...
          size="large"
            ...
            sx={{ borderColor: '#4285f4', color: '#ffffff' }}
          >
            Google로 계속하기
          </Button>
